    ...
    */
    ...
    public Dictionary<(int,int),LevelData> GenerateDefaultLevelData(){
        Dictionary<(int,int),LevelData> levelData = new Dictionary<(int, int), LevelData>(){
            ...
            {(3,1), new LevelData(3,1, true)},
            {(3,2), new LevelData(3,2, false)},
            {(3,3), new LevelData(3,3, false)},
            {(3,4), new LevelData(3,4, false)},
            {(3,5), new LevelData(3,5, false)},
            {(3,6), new LevelData(3,6, false)},
            {(3,7), new LevelData(3,7, false)},
            {(3,8), new LevelData(3,8, false)},
            {(4,1), new LevelData(4,1, true)},
            {(4,2), new LevelData(4,2, false)},
            {(4,3), new LevelData(4,3, false)},
            {(4,4), new LevelData(4,4, false)},
            {(4,5), new LevelData(4,5, false)},
            {(4,6), new LevelData(4,6, false)},
            {(4,7), new LevelData(4,7, false)},
            {(4,8), new LevelData(4,8, false)},
        };
        return levelData;
    }
